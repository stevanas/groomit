...
- **Location autocomplete**: Home "στην περιοχή" field uses Google Places Autocomplete (`/api/places/autocomplete`, region-biased to GR) with a dropdown + "Use my location" option; selecting a place navigates to correctly-filtered nearby stores.
